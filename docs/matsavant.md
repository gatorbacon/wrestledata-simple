...
- **Google Search Console**: set up 2026-09 as a URL-prefix property (`https://matsavant.com`), verified via HTML file — same method as KentuckyMat. Verification file: `frontend/wrestledata-ui/public/googled965ce574f260313.html`. Don't delete it; Google re-checks it periodically.
- **`robots.txt`**: `frontend/wrestledata-ui/public/robots.txt`, points at the sitemap.
